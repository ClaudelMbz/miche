          ...
          return (
            ...
            >
              <div
                ...
                className="w-full max-w-[300px] cursor-pointer group transition-transform duration-300 hover:scale-105"
                style={{
              ...
              >
                ...
                <div
                  className="relative w-full bg-white rounded-lg p-3 pb-6 polaroid-shadow border border-stone-200/70 transition-transform duration-700 flex flex-col justify-between"
                  style={{
                ...
                >
                  {/* FRONT FACE */}
                  <div
                    className="p-3 pb-6 flex flex-col bg-white rounded-lg h-full justify-between"
                    style={{
                      backfaceVisibility: 'hidden',
                      WebkitBackfaceVisibility: 'hidden',
                    }}
                  >
                    {/* Media Area (Photo or Video) - Passage en 9:16 strict */}
                    <div className="relative w-full aspect-[9/16] rounded-sm overflow-hidden bg-stone-900 border border-stone-200/50 flex items-center justify-center">
